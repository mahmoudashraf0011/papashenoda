...
import "./BooksCateMoreMainRes.css"
...
export default function OneBookC({ info, src, book, book_id, slug }) {
  ...
  return (
    <div className="books-section-one-books-info" style={{position:"relative",right:"15%",gap:"60px"}}>
      <div className="books-section-one-info">
