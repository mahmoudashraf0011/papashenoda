...
export const SkeletonBookCard = () => (
  <div className="skeleton-book-card-container">
    <div className="skeleton-book-card">
      ...
      <Skeleton height={200} width="70%" className="skeleton-book-img" />
    </div>
  </div>
);
const styles = `
  ...
  return (
    <div className="books-section-one-books-info">
      <div className="books-section-one-info">
        ...
        {/*         <div className='books-section-one-save' style={{ direction: "rtl", marginTop: "20%" }}><p><Link to={`/displayBook/${slug}`} onClick={getBook} style={{ cursor: "pointer" }}>{info}</Link></p></div>
 */}
        <div
          style={{
            direction: "rtl",
      ...
      <a href={`/displayBook/${slug}`} target='_blank'>
        <img
          ...
          style={{
            cursor: "pointer", marginTop: "18%", marginBottom: "10%",
            width:
              src === "/assets/default/books/Book - inside.png"
                ? "177px" // حجم الـ default
