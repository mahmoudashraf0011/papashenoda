...
export default function VideosFIlter({ cates, attrs, fetchVideos, notFound }) {
    ...
    if (localStorage.getItem("videosAttrDefault")) {
        let getdefaultAttrs = JSON.parse(localStorage.getItem("videosAttrDefault"))
    ...
    const onChooseCate = (e) => {
        ...
        localStorage.setItem("videosAttr", JSON.stringify(path))
        ...
        localStorage.setItem("videosAttrDefault", JSON.stringify(defaultAttrs))
        fetchVideos()
    }
    ...
    useEffect(() => {
        ...
        if (JSON.parse(localStorage.getItem("videosAttr")) === "") {
            localStorage.removeItem("videosAttr");
            localStorage.removeItem("videosAttrDefault");
        }
    ...
    function clearFilter() {
        ...
        // Re-fetch videos to show unfiltered data
        fetchVideos();
    }
    ...
    return (
        <div className='mediaFiltertion'>
            ...
            {
                localStorage.getItem("videosAttr") || localStorage.getItem("videosAttrDefault") ?
                    <button className='clearFilterBtn more_btn videosClear' onClick={() => clearFilter()}>مسح الكل</button>
                    :
                    ""
