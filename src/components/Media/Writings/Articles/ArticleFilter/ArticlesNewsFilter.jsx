...
export default function ArticlesNewsFilter({ cates, attrs }) {
    ...
    if (localStorage.getItem("articlesNewsAttrDefault")) {
        let getdefaultAttrs = JSON.parse(localStorage.getItem("articlesNewsAttrDefault"))
    ...
    const onChooseCate = (e) => {
        ...
        localStorage.setItem("articlesNewsAttr", JSON.stringify(path))
        ...
        localStorage.setItem("articlesNewsAttrDefault", JSON.stringify(defaultAttrs))
        getData()
    }
    ...
    useEffect(() => {
        ...
        if (JSON.parse(localStorage.getItem("articlesNewsAttr")) === "") {
            localStorage.removeItem("articlesNewsAttr");
            localStorage.removeItem("articlesNewsAttrDefault");
        }
    ...
    return (
        <div className='mediaFiltertion'>
            ...
            {
                localStorage.getItem("articlesNewsAttr") || localStorage.getItem("articlesNewsAttrDefault") ?
                    <button className='clearFilterBtn more_btn articlesNewsClear' onClick={() => clearFilter()}>مسح الكل</button>
                    :
                    ""
