...
export default function SayingFilterion({cates,attrs}) {
    ...
    if(localStorage.getItem("sayingAttrDefault")){
        let getdefaultAttrs=JSON.parse(localStorage.getItem("sayingAttrDefault"))
...
const onChooseCate=(e)=>{
    ...
    localStorage.setItem("sayingAttr",JSON.stringify(path))
    ...
    localStorage.setItem("sayingAttrDefault",JSON.stringify(defaultAttrs))
     getData()
}
...
useEffect(() => {
    ...
    if (JSON.parse(localStorage.getItem("sayingAttr")) === "") {
        localStorage.removeItem("sayingAttr");
        localStorage.removeItem("sayingAttrDefault");
    }
...
// Remove locaStorage Date if null
  ...
  }, [localStorage.getItem("sayingAttr")]);
...
// update Filter on remove Selected values
  ...
  return (
    <div className='mediaFiltertion'>
        ...
        {
            localStorage.getItem("sayingAttr") ||  localStorage.getItem("sayingAttrDefault")?
