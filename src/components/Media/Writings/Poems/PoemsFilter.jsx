...
export default function PoemsFilter({cates,attrs}) {
    ...
    if(localStorage.getItem("poemsAttrDefault")){
        let getdefaultAttrs=JSON.parse(localStorage.getItem("poemsAttrDefault"))
...
const onChooseCate=(e)=>{
    ...
    localStorage.setItem("poemsAttr",JSON.stringify(path))
    ...
    localStorage.setItem("poemsAttrDefault",JSON.stringify(defaultAttrs))
     getData()
}
...
useEffect(() => {
    ...
    if (JSON.parse(localStorage.getItem("poemsAttr")) === "") {
        localStorage.removeItem("poemsAttr");
        localStorage.removeItem("poemsAttrDefault");
    }
...
// update Filter on remove Selected values
  ...
  return (
    <div className='mediaFiltertion'>
        ...
        {
            localStorage.getItem("poemsAttr") ||  localStorage.getItem("poemsAttrDefault")?
             <button className='clearFilterBtn more_btn poemsClear' onClick={()=>clearFilter()}>مسح الكل</button>
            :
             ""
