...
export default function DocsFilter({ cates, attrs }) {
    const [docsData, filterAttrs, filterCates, getData, notFound, handleChangePage, pageCount, activePage] = DocsHook();
    ...
    if (localStorage.getItem("docsAttrDefault")) {
        let getdefaultAttrs = JSON.parse(localStorage.getItem("docsAttrDefault"))
    ...
    const onChooseCate = (e) => {
        ...
        localStorage.setItem("docsAttr", JSON.stringify(path))
        ...
        localStorage.setItem("docsAttrDefault", JSON.stringify(defaultAttrs))
        getData()
    }
    ...
    useEffect(() => {
        ...
        if (JSON.parse(localStorage.getItem("docsAttr")) === "") {
            localStorage.removeItem("docsAttr");
            localStorage.removeItem("docsAttrDefault");
        }
    ...
    return (
        <div className='mediaFiltertion'>
            ...
            {
                localStorage.getItem("docsAttr") || localStorage.getItem("docsAttrDefault") ?
                    <button className='clearFilterBtn more_btn docsClear' onClick={() => clearFilter()}>مسح الكل</button>
                    :
                    ""
