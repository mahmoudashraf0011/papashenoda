  ...
  return (
    <div className='sayingFilterPage'>
        <div className='Container'>
            {
              id=="written-quotes-more"?<SayingFilterion cates={sayingsWrittenFilter} attrs={sayingsWrittenAttrs} />
              :id=="pictures-and-sayings"?<SayingsPhotoFilterion cates={sayingsPhotoFilter} attrs={sayingsPhotoAttrs} />:""
            }
        </div>
